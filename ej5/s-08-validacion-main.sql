...
--En scripts reales no debe incluirse passwords. Solo se hace para
...
--
define p_usuario='bancos_bdd'

--
-- Password del usuario empleado en esta práctica
--
define p_usuario_pass='bancos_bdd'
...
Prompt =========================================================
Prompt Iniciando validador - Ejercicio práctico 5
Prompt Presionar Enter si los valores configurados son correctos.
Prompt De lo contrario editar el script s-08-validacion-main.sql
...
prompt    P - Con respecto a PAIS (default)
Prompt    B - Con respecto a BANCO
